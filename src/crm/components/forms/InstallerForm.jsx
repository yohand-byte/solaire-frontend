...
export default function InstallerForm({ onSubmit, onCancel, loading, initialData, isEdit }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <Select label="Formule" name="plan" value={form.plan} onChange={handleChange} options={[
          { value: 'essentiel', label: 'Essentiel - 5 dossiers' },
          { value: 'pro', label: 'Pro - 15 dossiers' },
          { value: 'serenite', label: 'Sérénité - 30 dossiers' }
        ]} />
        {isEdit && (
